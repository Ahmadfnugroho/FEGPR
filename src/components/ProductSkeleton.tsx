...
export default function ProductSkeleton() {
  return (
    <div className="rounded-xl md:rounded-lg border border-light dark:border-dark bg-white dark:bg-dark/90 p-2 md:p-3 shadow-sm h-full flex flex-col relative overflow-hidden">
      {/* Shimmer overlay */}

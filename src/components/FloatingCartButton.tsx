  ...
  return (
    <>
      ...
      <button
        ...
        className="relative text-slate-950 transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        aria-label={`Keranjang - ${totalItems} item`}
      >
        <div className="relative">
          <ShoppingBagIcon className="h-[20px] lg:h-8 lg:w-8" />
          {totalItems > 0 && (
